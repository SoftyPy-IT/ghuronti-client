      ...
      <div className="mt-5 mb-24">
        <div className="flex items-center justify-between px-8 mb-5">
          ...
          <div className={style.addHotel}>
            <Link href="/b2bdashboard/agent/create-agent/add-agent">
              <button>
                <span className="text-xl font-bold">+</span> Create Agent
              </button>
            </Link>
          </div>
        </div>
          ...
          <table className="table ">
            ...
            <tbody>
              <tr>
                ...
                <td>20-05-23</td>
                <td>
                  <Link href="/b2bdashboard/agent/create-agent/update">
...
export default dynamic(() => Promise.resolve(Agent), { ssr: false });
